...
class mod_db
{
	...
	public function __construct()
	{
		...
		##### Setting SQL Vars #####
		$sql_host = "localhost";
		$sql_name = "info_company";
		$sql_user = "ComodinUser7";	//Usuario
		$sql_pass = "mySecreto27"; // contraseña
		$charset = 'utf8mb4';
...
public function insertSeguro($tb_name, $data)
{
	...
	public function log($Usuario){
	 ...
	 // Preparar la consulta
		 ...
		 try {
		$sql = "SELECT * FROM usuarios WHERE Usuario = :User"; //CAMBIO QUE VALIDE USUARIO
		 $stmt = $this->conexion->prepare($sql);
